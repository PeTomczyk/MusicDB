...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:Z:\\SharedFiles\\#_Java\\Projects\\Music\\" + DB_NAME;
    ...
    public static final String QUERY_SONG = "SELECT " + COLUMN_SONG_ID + " FROM " +
            TABLE_SONGS + " WHERE " + COLUMN_SONG_TITLE + " = ?" + " AND " +
            COLUMN_SONG_ALBUM + " = ?";
...
//                artist.setName(results.getString(COLUMN_ARTIST_NAME));
    ...
    //where artists.name = "artistName" order by albums.name collate nocase asc
...
//    CREATE VIEW IF NOT EXISTS artist_list AS SELECT artists.name,
//    albums.name AS album, songs.track, songs.title FROM songs
...
//            System.out.format("Count = %d, Min = %d\n", count, min);
    ...
    public List<SongArtist> querySongInfoView(String title) {
        //SQL Injection: not possible (PreparedStatement used)
        try {
